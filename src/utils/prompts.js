export const COMPLEXITY_LEVELS = {
  CHILD: {
    ...
    accentLight: '#E76F51',
    accentDark: '#F4A261',
    themeGlowLight: 'bg-orange-500/10',
    themeGlowDark: 'bg-orange-500/10',
    cardBorderLight: 'border-orange-300',
    cardBorderDark: 'border-orange-900/50',
...
6. Keep the entire response under 80 words total.`
  ...
  TEEN: {
    ...
    shortLabel: '15yo',
    code: '15',
    badge: '15 / HIGH SCHOOL SAGE EDITION',
    accentLight: '#2D6A4F',
    accentDark: '#52B788',
    themeGlowLight: 'bg-emerald-500/10',
    themeGlowDark: 'bg-emerald-500/10',
    cardBorderLight: 'border-emerald-300',
    cardBorderDark: 'border-emerald-900/50',
...
5. Keep the total response length strictly between 150 and 200 words.`
  ...
  EXPERT: {
    ...
    shortLabel: 'Expert',
    code: 'EXP',
    badge: 'EXP / DOMAIN EXPERT EDITION',
    accentLight: '#1B4332',
    accentDark: '#74C69D',
    themeGlowLight: 'bg-teal-500/10',
    themeGlowDark: 'bg-teal-500/10',
    cardBorderLight: 'border-teal-300',
    cardBorderDark: 'border-teal-900/50',
