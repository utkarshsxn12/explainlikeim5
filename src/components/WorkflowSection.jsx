        ...
        {steps.map((s, idx) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -3 }}
              className="p-5 bg-[#E8E0D5]/50 dark:bg-[#23354D]/70 border border-[#1C1917]/20 dark:border-[#8EA8C3]/30 transition-all duration-300 rounded-2xl shadow-xs hover:border-[#1C1917] dark:hover:border-[#F0F4F8] group backdrop-blur-md"
            >
